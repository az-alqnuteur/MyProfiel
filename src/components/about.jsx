                ...
                >
                  <div className="col-md-12">
                    <div className="about-desc">
                      ...
                      <p>
                        I am a computer grad student from imam muhammad ibn saud
                        islamic university with IT major.I love exploring new
                        technologies and often amazed by the progress we as a
                        human species have mad so far in the recent years (apart
                        from the headphone-jack part!!)
                      </p>
                      {/* <p>
                        ...
                        any and don't want to live anymore 
                      </p> */}
                    </div>
                  </div>
                </div>
          ...
          <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have know how building mobile app using React Native  </p>
                </div>
                </div>
            </div>
            </div>
